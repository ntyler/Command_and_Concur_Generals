...
**Current milestone: [Milestone 11 — Supply Depots and Collector production](docs/milestone-11.md)** is implemented in `res://scenes/supply_depot_assault.tscn`; final validation is running. The corrected earned depot-to-collector-to-Rifle integration passes both modes. [Milestone 10](docs/milestone-10.md) remains complete, including its retained unknown-attribution graphical movement-stress failure. Documented movement limitations remain deferred and unresolved; full movement/Milestone 5 acceptance has not passed. No human playtest occurred. [Next focused feature](docs/roadmap.md#next-focused-feature--builder-driven-construction): Bulldozer-driven construction before power generation; current HQ-based automatic construction is prototype behavior.
