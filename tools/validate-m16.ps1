...
<# Ordinary M15 matrix plus M16 fortification suites; shared runner owns copies/deadlines. #>
[CmdletBinding()]
param(
...
$suites = @(
    'fortification_checks', 'fortification_combat_checks', 'fortification_breach_checks', 'fortification_integration_checks', 'fortification_ui_checks',
