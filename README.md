...
**Milestone 13 — Power Plants and power management:** implemented in [Power Assault](scenes/power_assault.tscn); validation is in progress. Open the scene and press **F6**, or launch Godot with `--path . res://scenes/power_assault.tscn`. [Milestone 13 report](docs/milestone-13.md).
