...
**Current milestone (2026-09-08): [Milestone 9 — Attack-move commands](docs/milestone-9.md) is COMPLETE** in the existing combined-arms assault scene. All eight acceptance groups pass automated validation, including corrected expanded Help at 1280x720 and 1920x1080. [Milestone 8.1 — HUD clarity and contextual selection](docs/milestone-8.1.md) remains complete, with its saved evidence preserved. Outstanding movement failures are **deferred known limitations, still unresolved**, and do not automatically block feature development. Full movement/Milestone 5 regression acceptance has not passed. The [current roadmap](docs/roadmap.md) preserves earlier repairs, tests and historical evidence while assessing each feature separately. Milestone 10 is not started.
